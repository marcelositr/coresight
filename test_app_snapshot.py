...
def run_snapshot():
    ...
    for line in app.formatted_output:
        ...
        clean_line = line.replace('\033[92m', '').replace('\033[94m', '').replace('\033[96m', '').replace('\033[0m', '').replace('\033[91m', '').replace('\033[5m', '').replace('\033[93m', '')
        print(clean_line)
